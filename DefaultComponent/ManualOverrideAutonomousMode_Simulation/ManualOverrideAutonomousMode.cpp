...
//!	Generated Date	: Tue, 9, Jun 2020  
	File Path	: DefaultComponent\ManualOverrideAutonomousMode_Simulation\ManualOverrideAutonomousMode.cpp
*********************************************************************/
...
IOxfReactive::TakeEventStatus ManualOverrideAutonomousMode::rootState_processEvent() {
    ...
    switch (rootState_active) {
        ...
        {
            if(IS_EVENT_TYPE_OF(OverrideDone_Usecases_TUesla_id))
                {
            ...
            else if(IS_EVENT_TYPE_OF(OverrideManual_Usecases_TUesla_id))
                {
