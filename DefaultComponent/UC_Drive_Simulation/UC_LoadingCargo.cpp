...
//!	Generated Date	: Sat, 13, Jun 2020  
	File Path	: DefaultComponent\UC_Drive_Simulation\UC_LoadingCargo.cpp
*********************************************************************/
...
char* UC_LoadingCargo::getMatrixDisp() const {
    return matrixDisp;
}

void UC_LoadingCargo::setMatrixDisp(char* p_matrixDisp) {
            ...
            if(IS_EVENT_TYPE_OF(cargoDoor_LoadingCargo_UseCaseModelling_TUesla_id))
                {
                    ...
                    matrixDisp = "Cargo door is Open. Please Load/Unload";
                    //#]
