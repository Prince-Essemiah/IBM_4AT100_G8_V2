...
//!	Generated Date	: Tue, 9, Jun 2020  
	File Path	: DefaultComponent\StopCrash_Simulation\LoadingCargo.cpp
*********************************************************************/
...
LoadingCargo::LoadingCargo(IOxfActive* theActiveContext) {
...
IOxfReactive::TakeEventStatus LoadingCargo::rootState_processEvent() {
    ...
    switch (rootState_active) {
        ...
        case waitForDock:
        {
            if(IS_EVENT_TYPE_OF(evDCTDocks_Usecases_TUesla_id))
                {
        ...
        {
            if(IS_EVENT_TYPE_OF(reqLoadDCT_Usecases_TUesla_id))
                {
        ...
        case CargoDoorOpen:
        {
            if(IS_EVENT_TYPE_OF(reqLoadingComplete_Usecases_TUesla_id))
                {
